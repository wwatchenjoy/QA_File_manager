...
const_dir_path = "C:/Users/Дмитрий/PycharmProjects/QA_File_manager/TEST DIRECTORY"
const_file_path = "C:/Users/Дмитрий/PycharmProjects/QA_File_manager/test_1.txt"
...
@pytest.fixture
def dir_work_1():
    if "QA_File_manager" not in const_dir_path:
        print("Нельзя работать вне папки QA_File_manager")
    else:
...
def copy_file():
    try:
        ...
        mark3 = "C:/Users/Дмитрий/PycharmProjects/QA_File_manager/text.txt"
...
def rename_file():
    try:
        ...
        mark3 = "C:/Users/Дмитрий/PycharmProjects/QA_File_manager/test_renamed.txt"
...
def move_file():
    try:
        ...
        mark = "C:/Users/Дмитрий/PycharmProjects/QA_File_manager/test_renamed.txt"
        mark3 = "C:/Users/Дмитрий/PycharmProjects/QA_File_manager/new_test_renamed.txt"
